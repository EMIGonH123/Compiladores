...
public class VistaLexico extends javax.swing.JFrame {
    ...
    public VistaLexico(OperacionesAutomata ventanaOperaciones) {
        ...
        Hashtable<Integer, String> objetos = ventanaOperaciones.getNombreObjetos();
        Enumeration<Integer> k = objetos.keys();
        while(k.hasMoreElements()){
            ListaNombreObjetos.addItem(objetos.get(k.nextElement()).toString());
        }
    }
    ...
    private void AceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarActionPerformed
        ...
        try {
            ...
            //String nombreObjeto = ListaNombreObjetos.getSelectedItem().toString() +".txt";
