...
public class VistaUnion extends javax.swing.JFrame {

    private OperacionesAutomata ventanaOperaciones;
    private Hashtable<Integer,Automata> automatas;
    
    public VistaUnion(OperacionesAutomata ventanaOperaciones, Hashtable<Integer,Automata> automatas) {
        initComponents();
    ...
    private void AceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarActionPerformed
        ...
        automataSelecionado1.unionAFN(automataSelecionado2);
