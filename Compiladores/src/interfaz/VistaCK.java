...
public class VistaCK extends javax.swing.JFrame {
    
    private OperacionesAutomata ventanaOperaciones;
    private Hashtable<Integer,Automata> automatas;
    
    public VistaCK(OperacionesAutomata ventanaOperaciones, Hashtable<Integer,Automata> automatas) {
        initComponents();
    ...
    public void setVentanaOperaciones(OperacionesAutomata ventanaOperaciones){
        this.ventanaOperaciones = ventanaOperaciones;
    }
    ...
    private void initComponents() {
        ...
        Titulo.setText("Cerradura Klenn");
    ...
    private void AceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarActionPerformed
        ...
        automataSelecionado.cerraduraUniversal();
        System.out.println("--------------------------------");
        System.out.println("----- CERRADURA UNIVERSAL  -----");
        System.out.println("--------------------------------");
        System.out.println("--------------------------------");
