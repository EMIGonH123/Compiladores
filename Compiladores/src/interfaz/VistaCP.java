...
public class VistaCP extends javax.swing.JFrame {
    ...
    public VistaCP(OperacionesAutomata ventanaOperaciones, Hashtable<Integer,Automata> automatas) {
        initComponents();
    ...
    private void initComponents() {
        ...
        Titulo.setText("Cerradura Positiva");
    ...
    private void AceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AceptarActionPerformed
        ...
        automataSelecionado.cerraduraPositiva();
        System.out.println("--------------------------------");
